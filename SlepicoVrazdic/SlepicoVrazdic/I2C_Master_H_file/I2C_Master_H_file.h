...
//Hodiny jsem nastavil na spravny cas pomoci kodu v projektu ClockModulTest

#ifndef I2C_MASTER_H_FILE_H_					/* Define library H file if not defined */
#define I2C_MASTER_H_FILE_H_

//#define F_CPU 8000000UL (thats for atmega 16)						/* Define CPU clock Frequency e.g. here its 8MHz */
